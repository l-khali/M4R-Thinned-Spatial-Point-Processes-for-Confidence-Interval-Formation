...
thinning_sv_08 <- poisson_simulation_thinning_sv(1000, 250, 0.8, 0.05)
...
thinning_sv_05 <- poisson_simulation_thinning_sv(1000, 250, 0.5, 0.05)
...
thinning_sv_02 <- poisson_simulation_thinning_sv(1000, 250, 0.2, 0.05)
...
thinning_sv_08_inhom <- poisson_simulation_thinning_sv(1000, 250, 0.8, 0.05, inhomogenous = TRUE)
...
thinning_sv_05_inhom <- poisson_simulation_thinning_sv(1000, 250, 0.5, 0.05, inhomogenous = TRUE)
...
thinning_sv_02_inhom <- poisson_simulation_thinning_sv(1000, 250, 0.2, 0.05, inhomogenous = TRUE)
...
thinning_sv_08_inhom_est <- poisson_simulation_thinning_sv(1000, 250, 0.8, 0.05, inhomogenous = TRUE, intensity_est = TRUE)
